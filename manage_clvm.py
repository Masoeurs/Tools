...
root = here.parent
cache_path = root.joinpath(".MSSF_cache", "manage_clvm.json")
...
from MSSF.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"MSSF"}
hashes_path = root.joinpath("MSSF/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("MSSF/wallet/puzzles")
...
main(auto_envvar_prefix="MSSF_MANAGE_CLVM")
