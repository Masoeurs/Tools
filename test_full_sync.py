...
from MSSF.cmds.init_funcs import MSSF_init
from MSSF.consensus.default_constants import DEFAULT_CONSTANTS
from MSSF.full_node.full_node import FullNode
...
async def run_sync_checkpoint(
    ...
    MSSF_init(root_path, should_check_keys=False, v1_db=False)
    ...
    async with full_node.manage():
        peer: WSMSSFConnection = FakePeer()  # type: ignore[assignment]
